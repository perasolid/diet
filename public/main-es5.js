...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppComponentsMyDietMyDietComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function MyDietComponent_div_6_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "div", 5);
      }
    }

    function MyDietComponent_div_7_tr_156_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MyDietComponent_div_7_tr_156_Template_button_click_155_listener() {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MyDietComponent_div_7_tr_156_Template_button_click_158_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);
    ...
    function MyDietComponent_div_7_Template(rf, ctx) {
      if (rf & 1) {
      ...
      _createClass(NutritionComponent, [{
        ...
        value: function getNutritions() {
          ...
          if (this.search === '') {
            this.nutritionService.getNutritionsWithPagination(this.currentPage, this.currnetLimit).subscribe(function (nutritions) {
              _this4.nutritions = nutritions;
            });
            this.nutritionService.getNutritionsCount().subscribe(function (res) {
              _this4.numberOfPages = Math.ceil(res.numberOfNutritions / _this4.currnetLimit);
            });
          } else {
            this.nutritionService.getNutritions(this.search).subscribe(function (nutritions) {
              _this4.nutritions = nutritions;

              _this4.toastr.success('Found ' + nutritions.length + ' nutrition/s', 'Success');
            });
          }
        }
      }, {
        ...
        value: function addNutrition() {
          ...
          this.nutritionService.addNutrition(this.nutrition).subscribe(function () {
            _this5.toastr.success('You successfully added a nutrition!', 'Success');

            document.getElementById('id01').style.display = 'none';

            _this5.clearDialog();

            _this5.getNutritions();
          }, function (err) {
        ...
        value: function updateNutrition() {
          ...
          this.nutritionService.updateNutrition(this.selectedNutrition).subscribe(function (data) {
            ...
            _this6.toastr.success('You successfully updated this nutrition!', 'Success');
        ...
        value: function deleteNutrition() {
          ...
          this.nutritionService.deleteNutrition(this.selectedNutrition._id).subscribe(function (data) {
            ...
            _this7.toastr.success('You successfully deleted this nutrition!', 'Success');

            if (data.n == 1) {
              for (var i = 0; i < _this7.nutritions.length; i++) {
                if (_this7.selectedNutrition._id == _this7.nutritions[i]._id) {
                  _this7.nutritions.splice(i, 1);
                }
              }
            }
          }, function (err) {
        ...
        value: function save() {
          ...
          this.auth.getHash(req).subscribe({
            next: function next(data) {
              if (_this9.details.hash === data.hash) {
                _this9.details.newPassword = _this9.newPassword;

                _this9.auth.updateUser(_this9.details).subscribe({
                  next: function next(data) {
                    if (_this9.newPassword !== '') {
                      _this9.details.password = _this9.newPassword;
                    } else {
                      _this9.details.password = _this9.currentPassword;
                    }

                    _this9.auth.login(_this9.details).subscribe(function () {
                      _this9.toastr.success('Changes saved successfully!', 'Success');
                    }, function (err) {
                      _this9.toastr.error('Could not update your profile!', 'Error');
                    });

                    _this9.getUserDetails();

                    _this9.currentPassword = '';
                    _this9.newPassword = '';
                    _this9.confirmationPassword = '';
                  },
                ...
                _this9.toastr.error('Current password is not correct!', 'Error');
              }
            },
        ...
        value: function register() {
          ...
          if (this.credentials.password === this.confirmationPassword) {
            ...
            this.auth.register(this.credentials).subscribe(function () {
              _this10.toastr.success('You successfully made an account!', 'Welcome ' + _this10.auth.getUserDetails().name);
  ...
  function srcAppComponentsSearchAndAddNutritionSearchAndAddNutritionComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SearchAndAddNutritionComponent_div_11_div_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SearchAndAddNutritionComponent_div_11_div_2_Template_button_click_6_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);
      ...
      _createClass(SearchAndAddNutritionComponent, [{
        ...
        value: function addNutrition(id) {
          ...
          this.userNutritionService.addNutrition(nutrition).subscribe(function () {
            ...
            _this12.toastr.success('You successfully added the food!', 'Success');
          }, function (err) {
      ...
      _createClass(SignInComponent, [{
        ...
        value: function login() {
          ...
          this.auth.login(this.credentials).subscribe(function () {
            ...
            _this13.toastr.success('You successfully signed-in!', 'Welcome ' + _this13.auth.getUserDetails().name);
          }, function (err) {
            _this13.toastr.error('Check email and password fields!', 'Error');
          });
        }
      }, {
        key: "ngOnInit",
      ...
      _createClass(UsersComponent, [{
        ...
        value: function getUsers() {
          ...
          if (this.search === '') {
            ...
            this.userService.getUsersCount().subscribe(function (res) {
              _this14.numberOfPages = Math.ceil(res.numberOfUsers / _this14.currnetLimit);
            });
          } else {
            this.userService.getUsers(this.search).subscribe(function (users) {
              _this14.users = users;

              _this14.toastr.success('Found ' + users.length + ' user/s', 'Success');
            });
          }
        }
      }, {
        ...
        value: function addUser() {
          ...
          if (this.credentials.password === this.confirmationPassword) {
            ...
            this.userService.addUser(this.credentials).subscribe(function () {
              _this15.toastr.success('You successfully added a user!', 'Success');
        ...
        value: function updateUser() {
          ...
          this.userService.updateUser(this.selectedUser).subscribe(function (data) {
            ...
            _this16.toastr.success('You successfully updated this user!', 'Success');
        ...
        value: function deleteUser() {
          ...
          this.userService.deleteUser(this.selectedUser._id).subscribe(function (data) {
            ...
            _this17.toastr.success('You successfully deleted this user!', 'Success');

            if (data.n == 1) {
              for (var i = 0; i < _this17.users.length; i++) {
                if (_this17.selectedUser._id == _this17.users[i]._id) {
                  _this17.users.splice(i, 1);
                }
              }
            }
          }, function (err) {
        ...
        value: function resetPassword() {
          ...
          this.userService.resetPassword(this.selectedUser).subscribe(function () {
            _this18.toastr.success('You successfully reset the password for user!', 'Success');
